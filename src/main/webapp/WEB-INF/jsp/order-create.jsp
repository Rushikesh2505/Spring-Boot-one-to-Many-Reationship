...
<body>
<h1>New Order</h1>
<form:form method="POST" commandName="order" action="${pageContext.request.contextPath}/order/SaveOrderswithProducts" >
<table>
<tbody>
<tr>
<td>Order name:</td>
...
<td><form:errors path="orderDescription" cssStyle="color: red;"/></td>
 ...
 <%-- <tr>
<td>Product 1:</td>
<td><form:input path="p1" /></td>
<td><form:errors path="Product" cssStyle="color: red;"/></td>
</tr> 
<tr>
<td>Product 2:</td>
<td><form:input path="p2" /></td>
<td><form:errors path="Product" cssStyle="color: red;"/></td>
</tr>--%>
<tr>
