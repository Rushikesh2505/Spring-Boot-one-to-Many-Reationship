...
<body>
<h1>New Order</h1>
<form:form method="POST" commandName="order" action="${pageContext.request.contextPath}/order/edit/${order.orderId}" >
<table>
<tbody>
<tr>
<td>Order name:</td>
...
<td><form:errors path="orderDate" cssStyle="color: red;"/></td>
</tr>
